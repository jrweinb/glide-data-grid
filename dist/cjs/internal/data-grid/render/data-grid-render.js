...
function drawGrid(arg, lastArg) {
    ...
    const drawHeaderTexture = () => {
        ...
        if (mustDrawFocusOnHeader) {
            (0, data_grid_render_rings_js_1.drawFocusRing)(overlayCtx, width, height, cellYOffset, translateX, translateY, effectiveCols, mappedColumns, theme, totalHeaderHeight, selection, getRowHeight, getCellContent, freezeTrailingRows, hasAppendRow, fillHandle, rows);
        }
    };
    ...
    if (damage !== undefined) {
        ...
        const doDamage = (ctx) => {
            ...
            if (fillHandle &&
                ...
                (0, data_grid_render_rings_js_1.drawFocusRing)(ctx, width, height, cellYOffset, translateX, translateY, effectiveCols, mappedColumns, theme, totalHeaderHeight, selection, getRowHeight, getCellContent, freezeTrailingRows, hasAppendRow, fillHandle, rows);
            }
        };
        if (damageInView) {
            doDamage(targetCtx);
    ...
    const focusRedraw = drawFocus
        ? (0, data_grid_render_rings_js_1.drawFocusRing)(targetCtx, width, height, cellYOffset, translateX, translateY, effectiveCols, mappedColumns, theme, totalHeaderHeight, selection, getRowHeight, getCellContent, freezeTrailingRows, hasAppendRow, fillHandle, rows)
        : undefined;
