...
function drawMarkerRowCell(args, index, checked, markerKind, drawHandle) {
    ...
    if (markerKind !== "number" && checkedboxAlpha > 0) {
        ...
        (0, draw_checkbox_js_1.drawCheckbox)(ctx, theme, checked, drawHandle ? x + offsetAmount : x, y, drawHandle ? width - offsetAmount : width, height, true, undefined, undefined, 18);
        if (drawHandle) {
