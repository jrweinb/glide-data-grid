...
export const uriCellRenderer = {
    ...
    provideEditor: cell => p => {
        ...
        return (React.createElement(UriOverlayEditor, { forceEditMode: forceEditMode || (cell.hoverEffect === true && cell.onClickUri !== undefined), uri: value.data, preview: value.displayData ?? value.data, validatedSelection: validatedSelection, readonly: value.readonly === true, onChange: e => onChange({
                ...value,
                data: e.target.value,
            }) }));
    },
